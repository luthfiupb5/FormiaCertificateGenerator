...
export default function DashboardPage() {
    ...
    return (
        <div className="min-h-screen bg-transparent font-sans selection:bg-primary/30 relative">
            {/* Dashboard Header */}
            <header className="fixed top-0 w-full h-20 border-b border-white/5 flex items-center justify-between px-8 bg-black/20 backdrop-blur-xl z-50">
                <Link href="/" className="flex items-center gap-2 group">
                    <img src="/assets/Logo-Light-gd.png" alt="Korae" className="h-10 w-auto group-hover:scale-105 transition-transform" />
                </Link>
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 animate-in slide-in-from-bottom-4 fade-in duration-700">
                    <div>
                        <h1 className="text-4xl font-bold font-heading mb-2">
                            ...
                            <span className="bg-gradient-to-r from-violet-400 to-blue-400 bg-clip-text text-transparent">Masterpieces</span>
                        </h1>
                        <p className="text-neutral-400">Continue where you left off or start a new creation.</p>
                    </div>
                    <Link href="/canvas">
                        <button className="px-6 py-3 rounded-full bg-white text-black font-bold text-sm hover:scale-105 transition-all shadow-lg shadow-violet-500/20 flex items-center gap-2 group">
                    ...
                    <>
                        {projects.length > 0 ? (
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 animate-in fade-in duration-700 delay-150">
                                ...
                                <Link href="/canvas" className="group relative bg-white/5 border border-white/5 border-dashed hover:border-violet-500/30 rounded-2xl p-6 flex flex-col items-center justify-center text-center gap-4 transition-all hover:bg-white/10 aspect-[4/3] hover:shadow-[0_0_30px_rgba(139,92,246,0.1)]">
                                    <div className="w-16 h-16 rounded-full bg-white/5 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 group-hover:bg-violet-500 group-hover:text-white text-neutral-400">
