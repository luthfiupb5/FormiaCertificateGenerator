            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6 py-20">
                ...
                <div className="space-y-12 text-lg leading-relaxed">
                    ...
                    <section>
                        ...
                        <p>
                            By accessing the website at <a href="https://korae.watermelonbranding.in/" className="text-violet-400 hover:text-violet-300 underline underline-offset-4">https://korae.watermelonbranding.in/</a>, you are agreeing to be bound by these terms of service, all applicable laws, regulations, and agree that you are responsible for compliance with any applicable local laws. If you do not agree with any of these terms, you are prohibited from using or accessing this site. The materials contained in this website are protected by applicable copyright and trademark law.
                        </p>
                    </section>
