            ...
            <div
                ...
                className={clsx(
                    ...
                    isDragActive
                        ...
                        : "border-slate-200 bg-white/60 hover:border-violet-500/50 hover:bg-white/80 hover:shadow-2xl hover:shadow-violet-900/20",
                ...
                {isProcessing ? (
                    ...
                    <>
                        <div className="relative">
                            ...
                            <div className="w-20 h-20 rounded-2xl bg-[#111] border border-slate-200 flex items-center justify-center shadow-2xl relative z-10 group-hover:scale-110 group-hover:border-violet-500/30 transition-all duration-500">
                        ...
                        <div className="text-center space-y-3 relative z-10">
                            ...
                            <p className="text-slate-600 text-sm">Drag & drop PDF or Image to start</p>

                            <div className="flex gap-2 justify-center mt-4">
                                {['PDF', 'PNG', 'JPG'].map(ext => (
                                    <span key={ext} className="px-2.5 py-1 bg-slate-50 border border-slate-100 rounded-md text-[10px] font-bold text-slate-500 group-hover:border-slate-200 group-hover:text-slate-600 transition-colors">
                                        {ext}
                                    </span>
                                ))}
                            </div>
